...
const CardInstagram: React.FC<CardInstagramInterface> = ({image}) => {
  return (
    <div className="rounded-3xl">
      ...
      <div className="py-4">
        <img src={image} alt="post" className="object-cover w-100 rounded-md" />
      </div>
      <div className='font-light text-sm md:text-lg'>
        <span className='font-semibold'>Certiblock</span> Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem
